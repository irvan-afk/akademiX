...
class MahasiswaUjianService {
  ...
  Future<String?> checkSesiPengerjaanStatus(int ujianId, int mahasiswaId) async {
  ...
  Future<Map<String, dynamic>?> getSesiPengerjaan(int ujianId, int mahasiswaId) async {
    return await _supabase
        .from('SESI_PENGERJAAN')
  ...
  Future<Map<String, dynamic>> createSesiPengerjaan(int ujianId, int mahasiswaId) async {
    return await _supabase
        .from('SESI_PENGERJAAN')
        .insert({
          'ujian_id': ujianId,
