...
class _PublishBankSoalScreenState extends State<PublishBankSoalScreen> {
      ...
      body: vm.isLoading
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isDraft = ujian.statusUjian.name == 'draft';
  ...
  Future<void> _handlePublishAction(
    ...
    if (tokens != null && mounted) {
      ...
      // Refetch ujian list to update status display
      final dosenId = context.read<AuthViewModel>().userData?['id'];
      if (dosenId != null && mounted) {
        await context.read<DosenUjianViewModel>().fetchUjianForDosen(dosenId);
      }
    }
  }
