...
class _DaftarMahasiswaViewState extends State<DaftarMahasiswaView> {
  ...
  void initState() {
    super.initState();
    // Memuat daftar mahasiswa yang sudah mengumpulkan jawaban melalui ViewModel
    Future.microtask(
      () => context.read<UjianViewModel>().fetchSubmissions(widget.ujianId),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Logika pencarian mahasiswa berdasarkan Nama atau NIM
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // Search Bar di area bottom AppBar
