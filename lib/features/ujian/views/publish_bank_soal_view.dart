...
/// This is separate from ${1}View (create & manage view).
class PublishBankSoalView extends StatefulWidget {
  const PublishBankSoalView({super.key});

  @override
  State<PublishBankSoalView> createState() => _PublishBankSoalViewState();
}

class _PublishBankSoalViewState extends State<PublishBankSoalView> {
  ...
  Future<void> _handlePublishAction(
    ...
    final tokens = await context.read<DosenUjianController>().publishUjian(
      ujian.id,
    );
