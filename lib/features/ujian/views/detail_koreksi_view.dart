...
class _DetailKoreksiViewState extends State<DetailKoreksiView> {
  ...
  void initState() {
    ...
    Future.microtask(() async {
      // 2. Gunakan DosenUjianController
      await context.read<DosenUjianController>().fetchDetailPengerjaan(
        widget.ujianId,
        widget.sesiId,
      );

      if (mounted) {
        for (var item in context.read<DosenUjianController>().detailPengerjaan) {
